...
class _SearchingViewState extends State<SearchingView>
  ...
  Widget _buildPulseAnimation({double size = 200}) {
    return SizedBox(
      width: size,
      height: size,
      child: AnimatedBuilder(
        ...
        builder: (context, child) {
          return Stack(
            ...
            children: [
              Container(
                width: size * _pulseController.value,
                height: size * _pulseController.value,
              ...
              Container(
                width: size * 0.75 * _pulseController.value,
                height: size * 0.75 * _pulseController.value,
                decoration: BoxDecoration(
                  shape: BoxShape.circle,
                  border: Border.all(
                    color: widget.primary.withOpacity(
              ...
              child: CachedNetworkImage(
                imageUrl:
                    widget.controller.myGames.firstWhereOrNull(
                      (g) => g['id'] == widget.controller.selectedGameId.value,
                    )?['image'] ??
                    '',
                width: 80,
                height: 80,
